...
app.use(session({
 	...
 	store:new MongoStore({
 		url:'mongodb+srv://shivamkumar262200628:8hDroYDBZFUtWqlY@cluster0.ekoym.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&ssl=true&sslCAPath=path-to-ca-file.pem',
...
mongoose.connect('mongodb+srv://shivamkumar262200628:8hDroYDBZFUtWqlY@cluster0.ekoym.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&ssl=true&sslCAPath=path-to-ca-file.pem',{useNewUrlParser:true,useUnifiedTopology:true,useFindAndModify:false}).then(()=>{
